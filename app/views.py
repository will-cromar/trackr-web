"""Contains functions for all HTML pages generated by web application."""
...
def load_user(user_id):
    """Needed for login manager to load a user."""
...
@login_required
def submitepisode():
    """Post an episode to the database."""
    form = EpisodeForm()
